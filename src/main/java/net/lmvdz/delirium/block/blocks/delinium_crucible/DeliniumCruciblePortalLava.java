...
public class DeliniumCruciblePortalLava extends DeliriumBlock {
    ...
    public DeliniumCruciblePortalLava() {
        super(FabricBlockSettings.of(Delinium.MAP_MATERIAL).nonOpaque().build(), RenderLayer.getEntityTranslucent(new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEX, new Identifier(DeliriumMod.MODID, "block/delinium_crucible_lava")).getTextureId()));
