...
public class DeliniumCruciblePortalTransparent extends DeliriumBlock {
    ...
    public DeliniumCruciblePortalTransparent() {
        super(FabricBlockSettings.of(DeliniumCrucible.MAP_MATERIAL).nonOpaque(), RenderLayer.getEntitySolid(new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEX, new Identifier(DeliriumMod.MODID, "block/transparent")).getTextureId()));
